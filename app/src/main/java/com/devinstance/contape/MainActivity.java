...
import com.devinstance.contape.controller.login_activity.LoginGoogle;
...
import com.devinstance.contape.DAL.UserDAO;
...
public class MainActivity extends AppCompatActivity {
  ...
  //  private String nomeUsuario, tipoUsuario;
    ...
    private final List<Transaction> listaTransactions = new ArrayList<>();
    //Variavel que recupera um objeto TarefaAdapter
    private TransactionAdapter transactionAdapter = new TransactionAdapter(listaTransactions, this, null);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent intentMovimentacoes = new Intent(this, TransactionActivity.class);
